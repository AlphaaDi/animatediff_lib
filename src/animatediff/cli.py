...
def refine(
    ...
    for repeat_count in range(repeats):
        ...
        for c in ["controlnet_canny","controlnet_depth","controlnet_inpaint","controlnet_ip2p","controlnet_lineart","controlnet_lineart_anime","controlnet_mlsd","controlnet_normalbae","controlnet_openpose","controlnet_scribble","controlnet_seg","controlnet_sam_seg","controlnet_shuffle","controlnet_softedge","controlnet_tile"]:
