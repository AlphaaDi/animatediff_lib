...
def get_infer_config(
    ...
    config_path: Path = get_dir("config").joinpath("inference/default.json" if not is_v2 else "inference/motion_v2_cross_attn.json")
...
class ModelConfig(BaseSettings):
    ...
    is_single_prompt_mode : bool = Field(True)
